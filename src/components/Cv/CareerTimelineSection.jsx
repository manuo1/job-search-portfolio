...
const timeline = [
  ...
  },
  {
    ...
    description: [
      ...
      "Acquisition massive de données via capteurs IoT et APIs EDF/GRDF/fournisseurs, avec optimisation de l'impact sur serveurs et base de données.",
      "Traitement des données, algorithmes de détection et prévisions de consommation, mise à disposition via APIs REST performantes",
